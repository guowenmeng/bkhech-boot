...
public class DateUtil {
    ...
    * 获取2个时间点相距的天差值
    * */
    public static Long getDateDayDiff(Date begin, Date end) {
        Long endLong = end.getTime();
        Long startLong = begin.getTime();
    ...
    * 获取2个时间点相距的小时差值
    * */
    public static Long getDateHourDiff(Date begin, Date end) {
        Long endLong = end.getTime();
        Long startLong = begin.getTime();
        Long diff = endLong - startLong;
    ...
    /*
       * 获取2个时间点相距的分差值
       * */
    public static Long getDateMiniteDiff(Date begin, Date end) {
        Long endLong = end.getTime();
        Long startLong = begin.getTime();
        Long diff = endLong - startLong;
